...
#' @examples 
#' \dontrun{
#' #create a list of balanced network using the two_bicomponents dataset
#' balanced_list <-create_balanced_blocks(two_bicomponents, 
#' bigraph = biconnected_components(two_bicomponents))
#' 
