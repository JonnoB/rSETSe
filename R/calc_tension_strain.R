...
#' It is called by default by all the embedding functions (SETSe_*) but is included here for completness.
#' 
...
#
#' @details Whilst the node embeddings dataframe contains the elevation of the SETSe alogirthm this function produces a data frame that contains the Tension
